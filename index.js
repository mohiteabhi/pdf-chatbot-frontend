...
app.post("/chat", async (req, res) => {
  ...
  const format = isChecklist ? "json" : detectRequestedFormat(question);
...
- "description": Detailed requirement SPECIFIC to the question
- "activities": Array of specific activities needed
- "periodicity": How often it must be performed
- "regulation_reference": RBI circular/master direction reference
- "action": "Actionable" or "Informational"
- "complianceType": Array of compliance types
- "status": Compliance status`.trim();
  } else {
    switch (format) {
      case "table":
        instruction =
